...
#ifndef EEDIT_TARGET_TOOLBOX_WINDOW_HEADER
#define EEDIT_TARGET_TOOLBOX_WINDOW_HEADER
...
private:
    ...
    pawsSpinBox     * tarZ;
    pawsSpinBox     * rot;
    pawsRadioButton * tarTypeNone;
    pawsRadioButton * tarTypeAxis;
    pawsRadioButton * tarTypeCustom;
